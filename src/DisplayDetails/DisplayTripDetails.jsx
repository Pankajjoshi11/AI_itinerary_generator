...
export const DisplayDetails = () => {
    ...
    const hotelImageURL = hotelDetails.HotelImageURL || "/default-hotel.jpg"; // Fallback image if none provided
                        ...
                        <div className="mt-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                <img
                                    ...
                                    onError={(e) => (e.target.src = "/default-hotel.jpg")} // Fallback image on load error
                                />
                                <div className="space-y-2">
                                    <p className="text-lg text-white"><strong>Address:</strong> {hotelAddress}</p>
                                    <p className="text-lg text-white"><strong>Price:</strong> {hotelPrice}</p>
                                    <p className="text-lg text-white"><strong>Rating:</strong> {hotelRating}</p>
                                    <p className="text-lg text-white"><strong>Description:</strong> {hotelDescription}</p>
                                </div>
                            </div>
